...
function get_header_portfolio_technologies()
{
  ...
  if ( ! empty( $term_query->terms ) ) {
      foreach ( $term_query->terms as $term ) {
		if($term->count == 0) {
		  if($term->slug === "capteurs") {
			$headertech[$term->term_id] = 0;
		  } elseif($term->slug === "actionneurs") {
		  ...
		  <div class="col-xs-12 col-md-12 col-lg-12">
			<div class="row">
			  ...
			  foreach($secondarycategories as $key => $secondarycategory) {
				if($oldsecondarycategoryid == $key) {
				  $chgtbordure = 0;
				} else {
				  $chgtbordure = 1;
				  $oldsecondarycategoryid = $key;
				}
				...
				foreach($products as $product) {
				  ...
				  ?>
					<div class="col-xs-2 col-md-2 col-lg-2 product">
					  <?php
						if($chgtbordure==1) {
							...
							?>
							<a href="<?php echo get_permalink( $product->ID )?>" class="caption" style="border-left-color:<?php echo $color;?>; background-color: white;" fncProductCategory>
							  <img class="imageproduct" style="height: auto !important;" src="<?php echo $image?>"/>
							</a>
						  <?php
						  ...
						  ?>
							<a href="<?php echo get_permalink( $product->ID )?>" fncProductCategory style="margin-top: 20%; border-left: none; background-color: white;" class="caption" > 
							  <img class="imageproduct" style="height: auto !important;" src="<?php echo $image?>"/>
							</a>
						  <?php
						  $nbarticle = $nbarticle + 1;

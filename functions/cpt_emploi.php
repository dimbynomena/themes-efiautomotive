...
function meta_box_callback( $post) {
	...
	<!--<p>
		...
		<!-- <select name="ville_73838" id="ville_73838" class="input_datas">
			...
			<option <?php //echo (get_meta_file( 'ville_73838' ) === 'Plymouth' ) ? 'selected' : '' ?>>Plymouth</option>
			<option <?php //echo (get_meta_file( 'ville_73838' ) === 'Elkmont' ) ? 'selected' : '' ?>>Elkmont</option>
			<option <?php //echo (get_meta_file( 'ville_73838' ) === 'Guadalajara' ) ? 'selected' : '' ?>>Guadalajara</option>


            <option <?php //echo (get_meta_file( 'ville_73838' ) === 'Beynost' ) ? 'selected' : '' ?>>Beynost</option>
			<option <?php //echo (get_meta_file( 'ville_73838' ) === 'Joinville' ) ? 'selected' : '' ?>>Joinville</option>
			<option <?php //echo (get_meta_file( 'ville_73838' ) === 'Berlin' ) ? 'selected' : '' ?>>Berlin</option>
			<option <?php //echo (get_meta_file( 'ville_73838' ) === 'Madrid' ) ? 'selected' : '' ?>>Madrid</option>



			<option <?php //echo (get_meta_file( 'ville_73838' ) === 'Rome' ) ? 'selected' : '' ?>>Rome</option>
			<option <?php //echo (get_meta_file( 'ville_73838' ) === 'Dudullu' ) ? 'selected' : '' ?>>Dudullu</option>
			<option <?php //echo (get_meta_file( 'ville_73838' ) === 'Tokyo' ) ? 'selected' : '' ?>>Tokyo</option>
			<option <?php //echo (get_meta_file( 'ville_73838' ) === 'Wuhan' ) ? 'selected' : '' ?>>Wuhan</option>
		</select> -->
	</p>	<p>

		<!--    localisation pays BO  --   >
		...
		<label for="ville_73838" class="labs_"><?php _e( 'Pays ville', 'caractristiques_des_offres' ); ?></label><br>
		
  

  <!-- <input type="text" id="default" list="languages" placeholder="Ville - pays"> -->
 <!--  	<input type="text" name="pays_73838" id="pays_73838" class="input_datas"  list="languages" placeholder="Ville - pays"> -->

		    <input list="languages" id="pays_73838" type="text" name="pays_73838" placeholder="Pays - Ville" style="width: 100%;" value="<?php echo get_meta_file( 'pays_73838' ); ?>" class="input_datas">
		


		<datalist id="languages">
		  	<select class="input_datas" id="pays_selected">
		  		<option  <?php echo (get_meta_file( 'pays_73838' ) === 'Allemagne - Boblingen' ) ? 'selected' : '' ?> class="input_datas">Allemagne - Boblingen</option>
		  		<option  <?php echo (get_meta_file( 'pays_73838' ) === 'Brésil - São Paulo' ) ? 'selected' : '' ?> class="input_datas">Brésil - São Paulo</option>
		  		<option  <?php echo (get_meta_file( 'pays_73838' ) === 'Chine - Wuman' ) ? 'selected' : '' ?> class="input_datas">Chine - Wuman</option>
		  		<option  <?php echo (get_meta_file( 'pays_73838' ) === 'Espagne - Madrid' ) ? 'selected' : '' ?> class="input_datas">Espagne - Madrid</option>
		  		<option  <?php echo (get_meta_file( 'pays_73838' ) === 'France - Beynost' ) ? 'selected' : '' ?> class="input_datas">France - Beynost</option>
		  		<option  <?php echo (get_meta_file( 'pays_73838' ) === 'France - Joinville' ) ? 'selected' : '' ?> class="input_datas">France - Joinville</option>
		  		<option  <?php echo (get_meta_file( 'pays_73838' ) === 'Italie - Turin' ) ? 'selected' : '' ?> class="input_datas">Italie - Turin</option>
		  		<option  <?php echo (get_meta_file( 'pays_73838' ) === 'Japon - Tokyo' ) ? 'selected' : '' ?> class="input_datas">Japon - Tokyo</option>
		  		<option  <?php echo (get_meta_file( 'pays_73838' ) === 'Mexique - Jalisco' ) ? 'selected' : '' ?> class="input_datas">Mexique - Jalisco</option>
		  		<option  <?php echo (get_meta_file( 'pays_73838' ) === 'Turquie - Istanbul' ) ? 'selected' : '' ?> class="input_datas">Turquie - Istanbul</option>
		  		<option  <?php echo (get_meta_file( 'pays_73838' ) === 'Usa - Plymouth' ) ? 'selected' : '' ?> class="input_datas">Usa - Plymouth</option>
		  		<option  <?php echo (get_meta_file( 'pays_73838' ) === 'Usa - Elkmont' ) ? 'selected' : '' ?> class="input_datas">Usa - Elkmont</option>
		  	</select>
		</datalist>
	...
	$hours_html = '
	  ...
	  <div class="form-group">
	   ...
	   <select class="form-control" id="job-hours" name="job-hours" onchange="this.form.submit()">
	    ...
	    <option value="all" selected="selected">'.__('Heures par semaines','theme-text-domain').'</option>

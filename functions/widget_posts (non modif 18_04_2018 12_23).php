...
class Custom_WP_Widget_Recent_Posts extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'custom_recent-posts', __( 'Dernier articles' ), $widget_ops );
			...
			<?php while ( $r->have_posts() ) : $r->the_post(); ?>
				...
				<li class="row">
					<a href="<?php the_permalink(); ?>">
						...
						<div class="colxs-12 col-sm-9 col-lg-10">
							<h5><?php echo get_the_category()[0]->name;?> - <?php echo $article->post_title?></h5>
						<h5><?php echo the_title();?></h5>
							<h6><?php echo  wp_trim_words( get_the_content(), 3, '...' )?></h6>
						</div>
					</a>
				<?php if ( $show_date ) : ?>

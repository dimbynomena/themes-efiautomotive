...
<div id="carousel-home" class="carousel slide">
	...
	while( $slides->have_posts() ) : $slides->the_post();
		...
		<div class="item <?php echo $active?>">
			<?php
			$Type=get_post_meta($post->ID, "_nectar_slider_bg_type")[0];
			if ($Type=='video_bg') { ?>
				<div class="image video">
					<iframe width="100%" height="100%" src="https://www.youtube.com/embed/<?php echo get_post_meta($post->ID, '_nectar_media_upload_webm')[0]; ?>?autoplay=1&controls=0&showinfo=0&loop=1&rel=0&playlist=<?php echo get_post_meta($post->ID, '_nectar_media_upload_webm')[0]; ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
				</div>
				<?php
			}
			else { ?>
		                    ...
		                    <div class="row category">
		                        <?php $i=1; foreach($category->articles as $article) : ?>
			                        <?php if ($i<5) { ?>
				                        ...
				                        <div class="col-xs-12 col-sm-6 col-lg-3 article toto">
										 <div class ="imageposthome">
				                            <a href="<?php echo get_permalink( $article->ID )?>" class="caption">
				                                <?php if ($image!='') { ?>
